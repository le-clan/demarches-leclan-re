...
Rails.application.config.content_security_policy do |policy|
  ...
  connect_whitelist += [URI(ENV["SENTRY_DSN_JS"]).host, URI(ENV["SENTRY_DSN_RAILS"]).host].compact.uniq if ENV['SENTRY_ENABLED'] == 'enabled'
  ...
  default_whitelist += [URI(ENV["SENTRY_DSN_JS"]).host, URI(ENV["SENTRY_DSN_RAILS"]).host].compact.uniq if ENV['SENTRY_ENABLED'] == 'enabled'
